...
<template>
    <div class="m-login-bonus-dialog-container">
        ...
        <v-btn class="m-close-login-bonus-button" icon="true" @click="$emit('closeLoginBonusDialog')" height="32"
            width="32">
                ...
                <v-col cols="4" class="pa-0 d-flex justify-center">
                    <div class="m-login-bonus-card-checkout-bg relative" v-if="loginBonusItem.signin_day >= 1">
                        ...
                        <img src="@/assets/public/svg/icon_public_18.svg" class="m-login-bonus-card-cash-position"
                            width="32" />
                        <p class="text-900-14 gray m-login-bonus-card-money-position">$ {{ loginBonusItem.award[0] }}</p>
                    </div>
                    <div class="m-login-bonus-card-bg-1 relative" v-ripple.center v-else @click="handleLoginBonus(1)">
                        <img src="@/assets/vip/image/img_vip_32.png" class="m-login-bonus-sunshine-img"
                            v-if="loginBonusItem.signin_day + 1 == 1" />
                        <p class="text-900-14 white m-login-bonus-text-position">{{ t('vip.login_bonus.day_1_text') }}</p>
                        <img src="@/assets/vip/image/img_vip_21.png" class="m-login-bonus-card-cash-position" width="29" />
                        <p class="text-900-14 white m-login-bonus-card-money-position">$ {{ loginBonusItem.award[0] }}</p>
                    </div>
                </v-col>
                <v-col cols="4" class="pa-0 d-flex justify-center">
                    <div class="m-login-bonus-card-checkout-bg relative" v-if="loginBonusItem.signin_day >= 2">
                        <p class="text-900-14 gray m-login-bonus-text-position">{{ t('vip.login_bonus.day_2_text') }}</p>
                        <img src="@/assets/public/svg/icon_public_18.svg" class="m-login-bonus-card-cash-position"
                            width="32" />
                        <p class="text-900-14 gray m-login-bonus-card-money-position">$ {{ loginBonusItem.award[1] }}</p>
                    </div>
                    <div class="m-login-bonus-card-bg-2 relative" v-ripple.center v-else @click="handleLoginBonus(2)">
                        <img src="@/assets/vip/image/img_vip_32.png" class="m-login-bonus-sunshine-img"
                            v-if="loginBonusItem.signin_day + 1 == 2" />
                        <p class="text-900-14 white m-login-bonus-text-position">{{ t('vip.login_bonus.day_2_text') }}</p>
                        <img src="@/assets/vip/image/img_vip_22.png" class="m-login-bonus-card-cash-position" width="40" />
                        <p class="text-900-14 white m-login-bonus-card-money-position">$ {{ loginBonusItem.award[1] }}</p>
                    </div>
                </v-col>
                <v-col cols="4" class="pa-0 d-flex justify-center">
                    <div class="m-login-bonus-card-checkout-bg relative" v-if="loginBonusItem.signin_day >= 3">
                        <p class="text-900-14 gray m-login-bonus-text-position">{{ t('vip.login_bonus.day_3_text') }}</p>
                        <img src="@/assets/public/svg/icon_public_18.svg" class="m-login-bonus-card-cash-position"
                            width="32" />
                        <p class="text-900-14 gray m-login-bonus-card-money-position">$ {{ loginBonusItem.award[2] }}</p>
                    </div>
                    <div class="m-login-bonus-card-bg-3 relative" v-ripple.center v-else @click="handleLoginBonus(3)">
                        <img src="@/assets/vip/image/img_vip_32.png" class="m-login-bonus-sunshine-img"
                            v-if="loginBonusItem.signin_day + 1 == 3" />
                        <p class="text-900-14 white m-login-bonus-text-position">{{ t('vip.login_bonus.day_3_text') }}</p>
                        <img src="@/assets/vip/image/img_vip_23.png" class="m-login-bonus-card-cash-position" width="50" />
                        <p class="text-900-14 white m-login-bonus-card-money-position">$ {{ loginBonusItem.award[2] }}</p>
                    </div>
                </v-col>
            </v-row>
            <v-row class="mt-6 mx-2">
                <v-col cols="4" class="pa-0 d-flex justify-center">
                    <div class="m-login-bonus-card-checkout-bg relative" v-if="loginBonusItem.signin_day >= 4">
                        <p class="text-900-14 gray m-login-bonus-text-position">{{ t('vip.login_bonus.day_4_text') }}</p>
                        <img src="@/assets/public/svg/icon_public_18.svg" class="m-login-bonus-card-cash-position"
                            width="32" />
                        <p class="text-900-14 gray login-bonus-card-money-position">$ {{ loginBonusItem.award[3] }}</p>
                    </div>
                    <div class="m-login-bonus-card-bg-4 relative" v-ripple.center v-else @click="handleLoginBonus(4)">
                        <img src="@/assets/vip/image/img_vip_32.png" class="m-login-bonus-sunshine-img"
                            v-if="loginBonusItem.signin_day + 1 == 4" />
                        <p class="text-900-14 white m-login-bonus-text-position">{{ t('vip.login_bonus.day_4_text') }}</p>
                        <img src="@/assets/vip/image/img_vip_24.png" class="m-login-bonus-card-cash-position" width="52" />
                        <p class="text-900-14 white m-login-bonus-card-money-position">$ {{ loginBonusItem.award[3] }}</p>
                    </div>
                </v-col>
                <v-col cols="4" class="pa-0 d-flex justify-center">
                    <div class="m-login-bonus-card-checkout-bg relative" v-if="loginBonusItem.signin_day >= 5">
                        <p class="text-900-14 gray m-login-bonus-text-position">{{ t('vip.login_bonus.day_5_text') }}</p>
                        <img src="@/assets/public/svg/icon_public_18.svg" class="login-bonus-card-cash-position"
                            width="32" />
                        <p class="text-900-14 gray m-login-bonus-card-money-position">$ {{ loginBonusItem.award[4] }}</p>
                    </div>
                    <div class="m-login-bonus-card-bg-4 relative" v-ripple.center v-else @click="handleLoginBonus(5)">
                        <img src="@/assets/vip/image/img_vip_32.png" class="m-login-bonus-sunshine-img"
                            v-if="loginBonusItem.signin_day + 1 == 5" />
                        <p class="text-900-14 white m-login-bonus-text-position">{{ t('vip.login_bonus.day_5_text') }}</p>
                        <img src="@/assets/vip/image/img_vip_25.png" class="m-login-bonus-card-cash-position" width="49" />
                        <p class="text-900-14 white m-login-bonus-card-money-position">$ {{ loginBonusItem.award[4] }}</p>
                    </div>
                </v-col>
                <v-col cols="4" class="pa-0 d-flex justify-center">
                    <div class="m-login-bonus-card-checkout-bg relative" v-if="loginBonusItem.signin_day >= 6">
                        <p class="text-900-14 gray m-login-bonus-text-position">{{ t('vip.login_bonus.day_6_text') }}</p>
                        <img src="@/assets/public/svg/icon_public_18.svg" class="m-login-bonus-card-cash-position"
                            width="32" />
                        <p class="text-900-14 gray m-login-bonus-card-money-position">$ {{ loginBonusItem.award[5] }}</p>
                    </div>
                    <div class="m-login-bonus-card-bg-4 relative" v-ripple.center v-else @click="handleLoginBonus(6)">
                        <img src="@/assets/vip/image/img_vip_32.png" class="m-login-bonus-sunshine-img"
                            v-if="loginBonusItem.signin_day + 1 == 6" />
                        <p class="text-900-14 white m-login-bonus-text-position">{{ t('vip.login_bonus.day_6_text') }}</p>
                        <img src="@/assets/vip/image/img_vip_26.png" class="m-login-bonus-card-cash-position" width="59" />
                        <p class="text-900-14 white m-login-bonus-card-money-position">$ {{ loginBonusItem.award[5] }}</p>
                    </div>
                </v-col>
            </v-row>
            <v-row class="mt-6 mx-2">
