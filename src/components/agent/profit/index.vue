...
<template>
    ...
    <v-row class="mx-6 m-agent-profit-summary-tab my-0">
        <v-col cols="4" class="text-center text-500-13" style="height: 100%" :class="summaryTabText == 'today'
            ? 'm-agent-profit-summary-tab-active white' : 'gray'" @click="handleSummaryTab('today')">
            {{ t("affiliate.statistics.tab.text_1") }}
        </v-col>
        <v-col cols="4" class="text-center text-500-13" style="height: 100%" :class="summaryTabText == 'week' ? 'm-agent-profit-summary-tab-active white' : 'gray'
            " @click="handleSummaryTab('week')">
            {{ t("affiliate.statistics.tab.text_2") }}
        </v-col>
        <v-col cols="4" class="text-center text-500-13" style="height: 100%" :class="summaryTabText == 'month' ? 'm-agent-profit-summary-tab-active white' : 'gray'
