        ...
        <v-card class="mx-2 m-agent-referral-partner-card">
            ...
            <div class="ma-4 d-flex">
                ...
                <v-card class="m-agent-referral-invitation-code ml-2">
                    ...
                    <div class="ma-2 text-400-12 text-white">6273728f800a98d4025a3073</div>
                    <v-btn icon="" @click="inviteUrlCopy('6273728f800a98d4025a3073')" class="m-invite-url-copy-btn"
                        width="24" height="24">
            ...
            <div class="mt-4 mx-4 d-flex justify-between">
                ...
                <div class="text-center">
                    <img src="@/assets/agent/svg/img_agent_10.svg" />
                    <div class="text-700-10 text-white">{{ t("agent.text_14") }}</div>
                </div>
                <div class="text-center">
                    <img src="@/assets/agent/svg/img_agent_11.svg" />
                    <div class="text-700-10 text-white">{{ t("agent.text_15") }}</div>
                </div>
                <div class="text-center">
                    <img src="@/assets/agent/svg/img_agent_12.svg" />
